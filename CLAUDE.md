...
> Loaded by Claude Code (and other agents) at the start of every session.
...
| -------------- | --------- | --------------------------------------------------- | ------------------------------ |
| **architect**  | `claude`  | architecture, hard reasoning, UI/UX, business logic | bulk completion, mass research |
